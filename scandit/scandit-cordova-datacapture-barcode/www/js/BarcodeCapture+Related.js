...
exports.BarcodeCaptureOverlay = exports.BarcodeCaptureFeedback = exports.BarcodeCaptureSession = void 0;
...
class BarcodeCaptureOverlay extends Serializeable_1.DefaultSerializeable {
    constructor() {
        ...
        this.brush = BarcodeCaptureOverlay.defaultBrush;
    }
    static get defaultBrush() {
        return new Viewfinder_1.Brush(Cordova_1.Cordova.defaults.BarcodeCapture.BarcodeCaptureOverlay.Brush.fillColor, Cordova_1.Cordova.defaults.BarcodeCapture.BarcodeCaptureOverlay.Brush.strokeColor, Cordova_1.Cordova.defaults.BarcodeCapture.BarcodeCaptureOverlay.Brush.strokeWidth);
    }
    get viewfinder() {
